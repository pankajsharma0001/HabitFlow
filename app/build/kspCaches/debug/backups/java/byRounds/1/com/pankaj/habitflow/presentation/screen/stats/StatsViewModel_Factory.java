...
public final class StatsViewModel_Factory implements Factory<StatsViewModel> {
  ...
  public StatsViewModel_Factory(Provider<HabitRepository> repositoryProvider) {
  ...
  public static StatsViewModel_Factory create(Provider<HabitRepository> repositoryProvider) {
    return new StatsViewModel_Factory(repositoryProvider);
  }

  public static StatsViewModel newInstance(HabitRepository repository) {
